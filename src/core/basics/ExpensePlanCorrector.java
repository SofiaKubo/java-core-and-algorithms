...
public class ExpensePlanCorrector {
    public static void main(String[] args) {
        ...
        System.out.println(
            "Вы планировали потратить: транспорт — " + transportMoney + ", "
                + "еда — " + foodMoney + ", "
                + "сбережения — " + savings + ".");
    }
    ...
    public static void correctExpenses(int salary, int transportMoney, int foodMoney, int savings) {
        ...
        int expensesSum =
            transportMoney + foodMoney + savings;
        if (expensesSum >
            salary) {
            ...
            System.out.println(
                "Придётся пересмотреть планы, вам не хватает " + lackMoney);
