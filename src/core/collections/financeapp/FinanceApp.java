...
public class FinanceApp {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (command == 1) {
                System.out.println(
                    "Ваши сбережения: " + moneyBeforeSalary + " RUB");
                ...
                String category = scanner.next();
                System.out.println(
                    "Самая большая трата в категории " + category +
                        " составила "
                ...
                System.out.println(
                    "Всего потрачено: " + expensesManager.getExpensesSum());
            } else if (command == 8) {
                ...
                System.out.println(
                    "В категории " + expensesManager.getMaxCategoryName() +
